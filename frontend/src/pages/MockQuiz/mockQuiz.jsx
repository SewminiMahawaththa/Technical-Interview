...
import HeaderImg from "../../assets/images/backgrounds/tech-bg.jpg";
import Modal from "../../components/Modal";
import ErrorModel from "../Quiz/model/ErrorModel";
import alertSound from '../Quiz/call-to-attention.mp3';
import AttentionDataBox from "../Quiz/AttentionDataBox";
import AttentionAlert from "../Quiz/model/AttentionAlert";
import SuccessQuizModel from "../Quiz/model/SuccessQuizModel";
import questions from "../../assets/json/mockQuizData.json";
...
const MockQuiz = () => {
    ...
    const startWebcam = async () => {
      try {
        ...
        if (!selectedDeviceId) {
          ...
          toast.error("No physical webcam found."); 
          return;
        }
  ...
  return (
    <div className="bg-cover bg-center bg-fixed">
      <div className="flex justify-center ">
        ...
        >
          ...
          <div className="flex justify-center items-center h-full">
            <span className="font-short-stack font-bold text-5xl text-white">Software Engineering_Mock Interview</span>
          </div>
        </div>
      </div>
      ...
      {showForm === "submit" && <SuccessQuizModel quiz={"Quiz"} score={totalScore} attentionPercentage={attentionPercentage} mock={true}/>}
